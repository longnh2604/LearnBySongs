...
//        avatarImageView.image = user.avatar
        nameListLabel.text = user.videoAuthor.localized + " " + user.videoAuthor.localized
        nameGridLabel.text = nameListLabel.text
        let userPostsString = ("0 posts • ").localized
        let userCommentsString = ("0 comments • ").localized
        let userLikesString = ("0 likes").localized
        statisticLabel.text = userPostsString + userCommentsString + userLikesString
    }
